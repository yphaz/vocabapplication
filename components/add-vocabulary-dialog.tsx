...
interface AddVocabularyDialogProps {
  ...
  onAdd: (vocabulary: Omit<VocabularyItem, "id" | "createdAt">) => void
}

// Generate A-Z alphabet array
const alphabetCategories = Array.from({ length: 26 }, (_, i) => String.fromCharCode(65 + i))

export default function AddVocabularyDialog({ open, onOpenChange, onAdd }: AddVocabularyDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] bg-gradient-to-b from-gray-900 to-black border border-gray-800 shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle className="text-primary">Add New Vocabulary</DialogTitle>
